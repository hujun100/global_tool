...
prototxt='/home/idealsee/GG3/sphereface_deploy.prototxt';
caffemodel='/home/idealsee/GG3/sphereface_model36_iter_200000.caffemodel';
data_key='data';
% feature_key='fc5';
...
% caffemodel='/home/scw4750/github/2D/2D_models/vggFace/best_result/lvgg_iter_125000.caffemodel';
% data_key='data';
% feature_key='fc7';
% is_gray=false;
% data_size=[224 224];
...
caffe.set_mode_gpu();
img_dir='/home/idealsee/github/AGE/CACD_VS_aligned/';
all_imgs_ffp = '/home/idealsee/github/AGE/cacd_test.txt';
