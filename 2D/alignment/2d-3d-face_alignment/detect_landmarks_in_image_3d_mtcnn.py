...
fa = face_alignment.FaceAlignment(face_alignment.LandmarksType._3D, enable_cuda=True, flip_input=False,  use_mtcnn=True)
...
for i in range(1, 26):
    ...
    file=h5py.File('/home/scw4750/face-alignment/examples/data/name_lm_bbox' + str(i) + '_3d_mtcnn.h5','w')
