...
for i in range(1, 26):
    ...
    preds_name, preds_lm, preds_bbox = fa.process_folder_hujun(list_name, all_faces=True)
    ...
    file=h5py.File('/home/scw4750/face-alignment/examples/data/name_lm_bbox' + str(i) + '_2d.h5','w')
